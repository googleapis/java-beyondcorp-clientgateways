...
```Groovy
implementation 'com.google.cloud:google-cloud-beyondcorp-clientgateways:0.7.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-beyondcorp-clientgateways" % "0.7.0"
```
